...
export function printQuote(order, admin) {
  ...
  const logo = "/redlogo.png"; // place your logo in /public
...
<head>
<meta charset="utf-8" />
<title>Quote – ${esc(order.orderId)}</title>
<style>
  :root { --brand: ${brand}; }
...
<body>
  ...
  <div class="muted" style="margin-top:24px">Generated by Brand brand-m3dia Kiosk Ordering System.</div>
